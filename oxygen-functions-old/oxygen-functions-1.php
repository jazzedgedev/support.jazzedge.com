...
add_shortcode('je_events_list', function($atts){
  ...
  if (!$css){ $css=true; ?>
    <style id="je-events-list-css">
      ...
      .je-events-list .je-view-btn{display:inline-block;background:#0a5d6c;color:#fff;padding:8px 16px;border-radius:6px;text-decoration:none;font-weight:600;font-size:13px;transition:all 0.2s ease;border:none;cursor:pointer;white-space:nowrap}
      .je-events-list .je-view-btn:hover{background:#f04e23;color:#fff;text-decoration:none;transform:translateY(-1px)}
      ...
      .je-events-list .je-calendar-link{color:#0a5d6c;text-decoration:none;font-weight:600;font-size:14px}
      .je-events-list .je-calendar-link:hover{color:#f04e23;text-decoration:underline}
    </style>
  <?php }
  ...
  // Add "View the full calendar" link
  echo '<div class="je-events-calendar-link">';
  echo '<a href="/events" class="je-calendar-link">View the full calendar →</a>';
  echo '</div>';
