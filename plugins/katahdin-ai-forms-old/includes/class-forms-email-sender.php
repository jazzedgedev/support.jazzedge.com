<?php
/**
 * Email Sender for Katahdin AI Forms
...
class Katahdin_AI_Forms_Email_Sender {
    ...
    public function send_analysis_email($form_data, $analysis, $prompt_id = null, $entry_id = null, $prompt_title = null, $prompt_text = null, $email_address = null, $email_subject = null) {
        try {
            // Use provided email settings or fallback to admin email
            $to_email = $email_address ?: get_option('admin_email');
            $subject = $email_subject ?: 'AI Analysis Results - Form Submission';
...
<body>
    <div class="container">
        ...
        $html .= '<strong>AI Model:</strong> ' . esc_html(get_option('katahdin_ai_forms_model', 'gpt-3.5-turbo')) . '<br>';
        ...
        <div class="footer">
            <p>This email was automatically generated by Katahdin AI Forms plugin.</p>
    ...
    public function test_email() {
        ...
        return $this->send_analysis_email($test_data, $test_analysis, 'test_prompt', 'test_entry', 'Test Prompt', 'This is a test prompt for email functionality testing.', 'test@example.com', 'Test Email Subject');
    }
    
    /**
     * Get email settings (now handled per prompt)
     */
    public function get_email_settings() {
        return array(
            'admin_email' => get_option('admin_email'),
            'note' => 'Email settings are now configured per prompt in the Form Prompts section'
        );
    }
    
    /**
     * Update email settings (deprecated - now handled per prompt)
     */
    public function update_email_settings($email, $subject) {
        // This method is deprecated as email settings are now per prompt
        return false;
    }
}
