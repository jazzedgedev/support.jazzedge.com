...
class Katahdin_AI_Forms_Admin {
            ...
            <div class="katahdin-ai-forms-admin">
                ...
                <div class="katahdin-forms-card">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        ...
                        <div style="text-align: center; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                            ...
                            <span class="katahdin-forms-status <?php echo $katahdin_status['api_connection_working'] ? 'success' : 'error'; ?>" id="katahdin-status">
                                <?php 
                        ...
                        <div style="text-align: center; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                            ...
                            <button type="button" class="katahdin-forms-button copy-url-btn" data-url="<?php echo esc_attr($webhook_url); ?>" style="margin-top: 10px; padding: 6px 12px; font-size: 12px;">Copy URL</button>
                        </div>
                        <div style="text-align: center; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                            ...
                            <button type="button" class="katahdin-forms-button secondary regenerate-secret-btn" style="margin-top: 10px; padding: 6px 12px; font-size: 12px;">Regenerate</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="katahdin-forms-card">
                    ...
                    <form method="post" action="options.php">
                        ...
                        <div class="settings-section">
                            ...
                            <table class="form-table">
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input type="checkbox" name="katahdin_ai_forms_enabled" value="1" 
                                                   <?php checked(get_option('katahdin_ai_forms_enabled', true)); ?> />
                        ...
                        <div class="settings-section">
                            ...
                            <p class="description">Email settings are now configured per prompt in the <a href="<?php echo admin_url('admin.php?page=katahdin-ai-forms-prompts'); ?>">Form Prompts</a> section. Each prompt can have its own email address and subject line.</p>
                        </div>
                ...
                <div class="katahdin-forms-card">
                    ...
                    <div style="margin: 20px 0;">
                        <button type="button" class="katahdin-forms-button test-api-key-btn" style="margin-right: 10px;">🔑 Test API Key</button>
                        <button type="button" class="katahdin-forms-button secondary check-status-btn" style="margin-right: 10px;">Check Status</button>
                        <button type="button" class="katahdin-forms-button primary comprehensive-debug-btn">🔍 Comprehensive Debug</button>
                    </div>
                </div>
                ...
                <div class="katahdin-forms-card">
                    ...
                    <div style="margin: 20px 0;">
                        <button type="button" class="katahdin-forms-button test-webhook-btn" style="margin-right: 10px;">Test Webhook</button>
                        <button type="button" class="katahdin-forms-button secondary test-email-btn" style="margin-right: 10px;">Test Email</button>
                        <button type="button" class="katahdin-forms-button secondary debug-info-btn" style="margin-right: 10px;">Debug Info</button>
                    </div>
                </div>
                    
                    <div id="test-results" style="display: none;">
                        <h3>Test Results</h3>
                        <div style="margin-bottom: 10px;"><button type="button" class="katahdin-forms-button secondary copy-debug-btn" data-target="test-output" style="font-size: 12px; padding: 6px 12px;">📋 Copy Results</button></div>
    ...
    "entry_id": "entry_id"
        ...
        .katahdin-forms-section:last-child {
            margin-bottom: 0;
        }
        </style>
        ...
        jQuery(document).ready(function($) {
            ...
            $('.test-api-key-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_test_api_key',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    if (response.success) {
            ...
            $('.debug-info-btn').on('click', function() {
                ...
                $.get('<?php echo rest_url('katahdin-ai-webhook/v1/debug'); ?>', {
                    ...
                    html += '<div style="margin-bottom: 10px;"><button type="button" class="katahdin-forms-button secondary copy-debug-btn" data-target="info-debug-content" style="font-size: 12px; padding: 6px 12px;">📋 Copy Results</button></div>';
            ...
            $('.debug-hub-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_debug_hub',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    ...
                    html += '<div style="margin-bottom: 10px;"><button type="button" class="katahdin-forms-button secondary copy-debug-btn" data-target="hub-debug-content" style="font-size: 12px; padding: 6px 12px;">📋 Copy Results</button></div>';
            ...
            $('.debug-api-call-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_debug_api_call',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    ...
                    html += '<div style="margin-bottom: 10px;"><button type="button" class="katahdin-forms-button secondary copy-debug-btn" data-target="api-debug-content" style="font-size: 12px; padding: 6px 12px;">📋 Copy Results</button></div>';
            ...
            $('.debug-rest-routes-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_debug_rest_routes',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    ...
                    html += '<div style="margin-bottom: 10px;"><button type="button" class="katahdin-forms-button secondary copy-debug-btn" data-target="routes-debug-content" style="font-size: 12px; padding: 6px 12px;">📋 Copy Results</button></div>';
            ...
            $('.simple-test-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_simple_test',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    ...
                    html += '<div style="margin-bottom: 10px;"><button type="button" class="katahdin-forms-button secondary copy-debug-btn" data-target="simple-test-content" style="font-size: 12px; padding: 6px 12px;">📋 Copy Results</button></div>';
    ...
    private function get_logs_debug_info() {
        try {
            ...
            $ajax_handlers = array(
                'katahdin_ai_forms_get_log_stats',
                'katahdin_ai_forms_get_logs',
                'katahdin_ai_forms_test_log',
                'katahdin_ai_forms_create_table',
                'katahdin_ai_forms_debug_logs'
            );
    ...
    public function ajax_debug_logs() {
        try {
            ...
            $debug_info['ajax_status'] = array(
                'ajax_url' => admin_url('admin-ajax.php'),
                'nonce_valid' => wp_verify_nonce($_POST['nonce'] ?? '', 'katahdin_ai_forms_nonce'),
                'user_can_manage_options' => current_user_can('manage_options'),
                'current_user_id' => get_current_user_id(),
                'is_admin' => is_admin()
            );
    ...
    public function add_admin_styles() {
        ...
        .katahdin-forms-form-table th {
            width: 200px;
            padding: 15px 10px 15px 0;
            vertical-align: top;
        }
        
        .katahdin-forms-form-table td {
            padding: 15px 0;
        }
        
        .katahdin-forms-form-table input[type="text"],
        .katahdin-forms-form-table input[type="email"],
        .katahdin-forms-form-table input[type="password"],
        .katahdin-forms-form-table textarea,
        .katahdin-forms-form-table select {
            width: 100%;
            max-width: 500px;
            padding: 10px;
            border: 1px solid #ddd;
        ...
        .katahdin-forms-button.secondary:hover {
            background: #e9ecef;
            color: #495057;
        }
        ...
        jQuery(document).ready(function($) {
            ...
            $('#cleanup-logs').on('click', function() {
                if (confirm('Are you sure you want to delete ALL logs? This cannot be undone.')) {
                    $.post(ajaxurl, {
                        action: 'katahdin_ai_forms_clear_all_logs',
                        nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                    }, function(response) {
                        if (response.success) {
            ...
            $('#create-table-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_create_table',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    if (response.success) {
            ...
            $('#debug-logs-system').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_debug_logs',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    if (response.success) {
            ...
            $('#test-log-btn').on('click', function() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_test_log',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    if (response.success) {
            ...
            function loadLogStats() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_get_log_stats',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>'
                }, function(response) {
                    if (response.success) {
            ...
            function loadLogs() {
                ...
                $.post(ajaxurl, {
                    action: 'katahdin_ai_forms_get_logs',
                    nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>',
                    limit: 50,
                    offset: 0,
                    status: status
                    ...
                    if (response.success) {
                        ...
                        if (logs.length > 0) {
                            ...
                            logs.forEach(function(log) {
                                ...
                                html += '<td><span class="katahdin-forms-status ' + log.status + '">' + log.status.charAt(0).toUpperCase() + log.status.slice(1) + '</span></td>';
    ...
    public function prompts_page() {
        ...
        jQuery(document).ready(function($) {
            ...
            function savePrompt() {
                ...
                var action = isEdit ? 'katahdin_ai_forms_update_prompt' : 'katahdin_ai_forms_add_prompt';
            ...
            function editPrompt(id) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        action: 'katahdin_ai_forms_get_prompt_by_id',
                        nonce: '<?php echo wp_create_nonce('katahdin_ai_forms_nonce'); ?>',
                        id: id
                    },
                    success: function(response) {
