...
class Katahdin_AI_Webhook_Email_Sender {
     ...
     * Send analysis email
     */
    public function send_analysis_email($form_data, $analysis, $form_id = null, $entry_id = null) {
        try {
            // Get email settings
            ...
            $email_content = $this->prepare_email_content($form_data, $analysis, $form_id, $entry_id);
     ...
     * Prepare email content
     */
    private function prepare_email_content($form_data, $analysis, $form_id, $entry_id) {
...
<body>
    ...
    public function test_email() {
        ...
        return $this->send_analysis_email($test_data, $test_analysis, 'test_form', 'test_entry');
    }
